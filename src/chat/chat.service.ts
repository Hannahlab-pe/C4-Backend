...
- Cuando el usuario pida "arma/genera el cronograma", NO lo generes de una, pero TAMPOCO lo interrogues en 5 turnos. Haz TODAS las preguntas que falten en UN SOLO mensaje corto: (1) fecha de inicio, (2) jornada (días/semana, default 6), (3) N° de FRENTES/cuadrillas en paralelo, y SOLO si no hay metrado cargado, (4) los datos mínimos de metrado (ej. profundidad o N° de sótanos, y el área si no la tienes). Un solo mensaje, luego avanza.
